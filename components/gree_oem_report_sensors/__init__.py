...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_LAST_0X33_PAYLOAD): text_sensor.text_sensor_schema(text_sensor.TextSensor),
        ...
        cv.Optional(CONF_LAST_0X40_PAYLOAD): text_sensor.text_sensor_schema(text_sensor.TextSensor),
        cv.Optional(CONF_POWER_DISCOVERY_SUMMARY): text_sensor.text_sensor_schema(text_sensor.TextSensor),
        ...
        cv.Optional(CONF_INDOOR_REPORT_BYTE_6_RAW): raw_byte_schema,
